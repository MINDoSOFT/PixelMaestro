...
namespace PixelMaestro {
	class Colors {
		public:
			...
			static void generate_comet(std::vector<RGB>* array, uint8_t array_size, RGB& start_color, RGB& end_color, uint8_t comet_start, uint8_t comet_length);
			static RGB generate_random_color();
			static void generate_random_color_array(std::vector<Colors::RGB>* array, uint8_t num_colors);
			static void generate_scaling_color_array(std::vector<Colors::RGB>* array, RGB& base_color, RGB& target_color, uint8_t num_colors, bool mirror = false);
